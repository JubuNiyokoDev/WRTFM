  ...
  return (
    <AppLayout>
      <Switch>
        ...
        <ProtectedRoute path="/client/campaigns/:id" role="client" component={ClientCampaignDetail} />
        <ProtectedRoute path="/client/campaigns" role="client" component={ClientCampaigns} />
        <ProtectedRoute path="/client/wallet" role="client" component={ClientWallet} />
        <ProtectedRoute path="/client/profile" role="client" component={ClientProfile} />
        <ProtectedRoute path="/client/reports" role="client" component={ClientReports} />
        <ProtectedRoute path="/client" role="client" component={ClientDashboard} />

        <ProtectedRoute path="/worker/tasks/:id" role="worker" component={WorkerTaskDetail} />
        <ProtectedRoute path="/worker/tasks" role="worker" component={WorkerTasks} />
        <ProtectedRoute path="/worker/earnings" role="worker" component={WorkerEarnings} />
        <ProtectedRoute path="/worker/profile" role="worker" component={WorkerProfile} />
        <ProtectedRoute path="/worker" role="worker" component={WorkerDashboard} />

        <ProtectedRoute path="/admin/verifications" role="admin" component={AdminVerifications} />
        <ProtectedRoute path="/admin/users" role="admin" component={AdminUsers} />
        <ProtectedRoute path="/admin/campaigns" role="admin" component={AdminCampaigns} />
